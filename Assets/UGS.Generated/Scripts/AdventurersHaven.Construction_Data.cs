...
namespace AdventurersHaven
{
    ...
    { 
        ...
        public delegate void OnLoadedFromGoogleSheets(List<Construction_Data> loadedList, Dictionary<int, Construction_Data> loadedDictionary);

        static bool isLoaded = false;
        static string spreadSheetID = "1DE69qF4w2rp6ZoH9e1cs3t_OK4SO1F7KoRRX16lpkog"; // it is file id
        static string sheetID = "904056673"; // it is sheet id
        static UnityFileReader reader = new UnityFileReader();

/* Your Loaded Data Storage. */
    
        public static Dictionary<int, Construction_Data> Construction_DataMap = new Dictionary<int, Construction_Data>();  
        ...
        /// - Auto Load
        /// </summary>
        public static Dictionary<int, Construction_Data>  GetDictionary()
        {{
           if (isLoaded == false) Load();
...
#region fuctions
        ...
        public static void LoadFromGoogle(System.Action<List<Construction_Data>, Dictionary<int, Construction_Data>> onLoaded, bool updateCurrentData = false)
        {      
    ...
    public static (List<Construction_Data> list, Dictionary<int, Construction_Data> map) CommonLoad(Dictionary<string, Dictionary<string, List<string>>> jsonObject, bool forceReload){
            Dictionary<int, Construction_Data> Map = new Dictionary<int, Construction_Data>();
