...
### 장르 : 건설/경영 시뮬레이션
```
“모험가의 쉼터”는 전투와 모험으로 지친 모험가들이 편안히 쉴 수 있는
공간을 경영하는 시뮬레이션 게임입니다. 플레이어는 상점에서 다양한 상품을
판매하여 수익을 창출하고, 늘 찾아오는 모험가 손님들의 만족도를 관리해야 합니다. 
그러나 간헐적으로 슬라임이 투명화 능력을 사용해 가게의 돈을 훔쳐 가므로,
이를 방지하기 위해 적절한 수의 경비병을 고용해 슬라임을 체포해야 합니다.

게임의 최종 목표는 “쉼터”가 파산하지 않도록 자금 흐름을 안정적으로 유지하면서,
모험가들에게 안전하고 아늑한 쉼터를 제공하는 것입니다. 해당 목표를 달성하기 위해서는
상품 구성과 가격 책정, 경비병 배치의 균형을 잘 맞추는 전략이 핵심이 됩니다.
```
